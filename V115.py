...
def main():
    ...
    banner()
    print(f' ')
    print(f'{M}╔══[•] TOOL NAME : {H}MR,VEAR GREEN X')
    print(f'{M}║══[•] YOUR IP   :{H} ')
...
def gmail():
    ...
    with ThreadPool(max_workers=60) as shanto:    
        ...
        if tl <uid:
         print('        \033[1;90m[\033[1;93mMR,VEAR\033[1;90m] \033[1;90m[\033[1;95m4444\033[1;90m] \033[1;92mOK \033[1;90m[\033[1;92m15\033[1;90m] ')
                #sys.stdout.flush()
    ...
    with ThreadPool(max_workers=60) as shanto:    
        ...
        for love in user:
            ...
            for ps in pwx:
                ...
                #print(f'    {B}[COOKI💉] {B}datr=6h4NZdi8mzrhmqhe-1HzGMXd; sb=6h4NZdXRNbdVEzd3_J9nBKZG; m_pixel_ratio=2; c_user=10009'+love+nnn+'; xs=30%3AxnET70hRrt2qrA%3A2%3A1695'+nop+'%3A-1%3A1928; fr=0Uh76ULZ4BjMf0iR3.AWUcqax6BSH82jI2sVV_K4gc9XA.BlDR7q.pD.AAA.0.0.BlDR99.AWVzk7kgK5g; x-referer=%3D%3D; m_page_voice=10009'+love+nnn+'; wd=360x800')
        if tl <uid:
         print('        \033[1;90m[\033[1;91mMR,VEAR\033[1;90m] \033[1;90m[\033[1;92m4532\033[1;90m] \033[1;92mOK \033[1;90m[\033[1;92m8\033[1;90m] ')
                #sys.stdout.flush()
